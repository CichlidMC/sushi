...
/**
 * An arbitrary condition that must be met for a {@link Transformer} to be loaded.
 */
public interface Condition {
	SimpleRegistry<MapCodec<? extends Condition>> REGISTRY = SimpleRegistry.create(SushiBootstraps::bootstrapConditions);
